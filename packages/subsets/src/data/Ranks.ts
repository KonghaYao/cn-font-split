 ...
 * */
export const Latin = UnicodeRange.parse(
 ...
 * @link https://npmmirror.com/package/@fontsource/noto-sans/files/400.css?version=5.0.22#L61
 * */
export const LatinExt = UnicodeRange.parse(
...
export const Vietnamese = UnicodeRange.parse(
...
export const Greek = UnicodeRange.parse(
    'U+0370-0377,U+037A-037F,U+0384-038A,U+038C,U+038E-03A1,U+03A3-03FF'.split(
        ',',
    ),
);
export const GreekExt = UnicodeRange.parse(['U+1F00-1FFF']);

export const Cyrillic = UnicodeRange.parse(
    'U+0301,U+0400-045F,U+0490-0491,U+04B0-04B1,U+2116'.split(','),
);
export const CyrillicExt = UnicodeRange.parse(
 ...
 */
export const Bengali = UnicodeRange.parse(
 ...
 */
export const Devanagari = UnicodeRange.parse(
 ...
 */
export const Arabic = UnicodeRange.parse(
