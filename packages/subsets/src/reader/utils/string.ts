...
export default {
     ...
     */
    toPascalStringBytes(str: string) {
        const bytes: number[] = [];
     ...
     */
    getPascalString(byteArray: Uint8Array) {
