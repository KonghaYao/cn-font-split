export default function (moduleArg = {}) {
    ...
    function createWasm() {
        ...
        const instance = new WebAssembly.Instance(Module.instance, {
            a: wasmImports,
        });
    ...
    function craftInvokerFunction(
        ...
        return (function (
            ...
            return function compress(arg0) {
                if (arguments.length !== 1) {
                    throwBindingError(
                        'function compress called with ' +
                            arguments.length +
    ...
    var _malloc = (a0) => (wasmExports['v'])(a0);
    ...
    var __embind_initialize_bindings = (Module['__embind_initialize_bindings'] =
        () =>
            (__embind_initialize_bindings = Module[
