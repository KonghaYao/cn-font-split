...
| 更新时间： 2023/ 5 / 15 | 江夏尧 | Version 3.2.0 |
...
3. 有些字体本身对于中文符号没有设置全角大小，导致文本符号紧凑，这个是切割插件没法修补的。
4. 如果 woff2 相关的打包，出现了问题，极大可能是 nodejs 版本太高，[详见此处](https://github.com/KonghaYao/cn-font-split/issues/4)。
5. 3.0.4 及以下版本打包结果缺失非常重要的字体配置文件！
